...
import 'package:lojinha_virtual/models/cart_product.dart';
...
import 'package:lojinha_virtual/services/cepaberto_service.dart';
import 'address.dart';
...
class CartManager extends ChangeNotifier{
  ...
  Future<bool> calculateDelivery(double lat, double long) async {
    ...
    final minkm = doc.data['minkm'] as num;
    ...
    deliveryPrice = base;
    return true;
     /*if (address.zipCode == '59808000' || address.zipCode == '59800000' || dis <= minkm){
      deliveryPrice = 0;
      return true;
    } else {
      deliveryPrice = base;
